...
export const Canvas: React.FC<CanvasProps> = ({ blocks, onDrop, onRemove, onReorder }) => {
  ...
  const handleDrop = (e: React.DragEvent, index: number) => {
    ...
    try {
      ...
      if (data) {
        ...
        // Check if it's an internal reorder or a new drop
        // For simplicity in this version, we handle reorders via removing and adding if ID exists, 
        // or the parent handles logic if we pass the raw data.
        // Here we just pass to onDrop.
        onDrop(block, index);
      }
    } catch (err) {
              ...
              <React.Fragment key={block.id}>
                ...
                <div className="relative group">
                  <Block 
                    ...
                    onDragStart={(e) => {
                      // We attach the original index to allow reordering detection
